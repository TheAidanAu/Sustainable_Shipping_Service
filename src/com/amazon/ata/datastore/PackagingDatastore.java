...
public class PackagingDatastore {
     ...
     * Make it over-loaded, one for creating a box, one for creating a polybag
     */
    ...
    private FcPackagingOption createFcPackagingOption(String fcCode, Material material,
        ...
        FulfillmentCenter fulfillmentCenter = new FulfillmentCenter(fcCode);
        // new line: I'm still creating a Packaging reference type but the object type is a Box
        Packaging packaging = new Box(new BigDecimal(length), new BigDecimal(width), new BigDecimal(height));
        //old line:
        // Packaging packaging = new Packaging(material, new BigDecimal(length), new BigDecimal(width), new BigDecimal(height));
